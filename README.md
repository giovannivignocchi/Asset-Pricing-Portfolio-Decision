...
This project is a strategic exercise in asset selection and risk assessment, utilizing historical data. It involves building the Global Minimum Variance Portfolio, balancing various constraints, and exploring the integration of risk-free assets, all within the framework of the Capital Asset Pricing Model.
